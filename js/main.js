...
/*$(document).ready(
  function () {
    $( "object" ).mouseenter(function() {
      $(".home-header").css("background-color", "#FFFFFF");
      $(".reverse-background-color").css("background-color", "#ED7203");
      $(".reverse-color").css("color", "#ED7203");
    });
    $( "object" ).mouseleave(function() {
      $(".home-header").css("background-color", "#ED7203");
      $(".reverse-background-color").css("background-color", "#FFFFFF");
      $(".reverse-color").css("color", "#FFFFFF");
    });
  });*/
$(document).ready(
  ...
  function loadGallery(setIDs, setClickAttr){
      ...
      function updateGallery(selector) {
          ...
          if ($sel.data('project-link')) {
            $('#modal-project-link').css("display", "inherit");
          } else {
            $('#modal-project-link').css("display", "none");
          }
          $('#modal-project-title').text($sel.data('project-title'));
          $('#modal-project-objective').text($sel.data('project-objective'));
          $('#modal-project-about').text($sel.data('project-about'));
          $('#modal-project-tech-talk').text($sel.data('project-tech-talk'));
          $('#modal-project-link').attr('href', $sel.data('project-link'));
